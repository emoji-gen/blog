...
<small>※ 補足:  Google Analytics の集計結果です。端数を除いているため、合計は 100 % になりません。</small>
...
<a href="{static}/images/202001xx/architecture.png">
  <img src="{static}/images/202001xx/architecture.png" width="300" height="110" alt="">
</a>
...
Vue.js で構築されたアプリケーションは、Vue I18n を用いることで簡単に多言語対応ができることを説明しました。
